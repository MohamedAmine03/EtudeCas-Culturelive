...
ALTER TABLE ONLY public.film
    ADD CONSTRAINT film_original_language_id_fkey FOREIGN KEY (original_language_id) REFERENCES public.language(language_id);


--
-- Name: rental fk_customer; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: rental fk_rental_film; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.rental
    ADD CONSTRAINT fk_rental_film FOREIGN KEY (film_id) REFERENCES public.film(film_id);
